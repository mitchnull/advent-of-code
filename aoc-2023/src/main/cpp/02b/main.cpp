...
// Game 82: 8 green, 1 blue; 2 blue, 4 red; 7 green, 1 red, 4 blue; 2 green, 3 red, 2 blue; 3 red; 4 red, 8 green, 1
// blue
...
check(const std::string &line) {
  ...
  return std::ranges::fold_left(
      minCounts | std::views::transform([](auto e) { return e.second; }), 1, std::multiplies<>());
}
